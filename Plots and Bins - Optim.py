...
def check_ir_or_mass(mol_dict):
    ...
    if data_type in [CONFIG["infrared_spectrum"], CONFIG["mass_spectrum"], CONFIG["mass"]]:
        return data_type
    return False
    ...
    for cas_id, value in config.items():
        ...
        try:
            ...
            if mol_dict:
                ...
                if ir_or_ms == CONFIG["infrared_spectrum"]:
                ...
                elif ir_or_ms in [CONFIG["mass_spectrum"], CONFIG["mass"]]:
                    ...
                    logging.warning(f"Data type for {file_type} is neither infrared nor mass spectrum.")
            else:
                logging.warning(f"Failed to read data from file at {file_path}.")
...
if __name__ == "__main__":
    config_file_path = '/Users/rudrasondhi/Desktop/Specto/Specto/Data/IR_Spectra/Super Cool Data/all_data_MS&IR_PATHS_2.yaml'
